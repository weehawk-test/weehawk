    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-destructive/30 bg-destructive/5 p-6 shadow-sm">
        ...
        <p className="mb-4 max-w-2xl text-sm text-muted-foreground">
          ...
          invites you. If you are the only member, the organization is closed and org-scoped resources return to
          personal workspaces.
        </p>
        <button
          type="button"
              ...
              <AlertDialogDescription asChild>
                <div className="space-y-2 text-sm text-muted-foreground">
                  {!org.isOwner ? (
                    ...
                    <p>
                      You are the only member. Leaving will close this organization and unlink its scope from team
                      resources (they stay on owner accounts as personal workspace items).
                    </p>
                  ) : (
                    <p>
