...
export function WebhookDetailsClient({ initialWebhook, activeOrgPublicId }: Props) {
  const router = useRouter();
  const webhook = initialWebhook;

  const deleteMutation = useDeleteWebhook(activeOrgPublicId);
