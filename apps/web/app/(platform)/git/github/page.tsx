...
/**
 * GitHub’s documented flow: POST to /settings/apps/new with a JSON string in `manifest`.
 * The GET ?manifest_url=… shortcut often leaves fields empty; this matches tools like Dokploy.
 */
