        ...
        {showAdd && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-4xl max-h-[88vh] overflow-y-auto glass-panel rounded-2xl border border-primary/25 p-5 sm:p-6"
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center flex-shrink-0">
                      {(() => {
                        ...
                        if (!meta) return <Bell className="w-5 h-5 text-primary" />;
                        const PlatformIcon = meta.icon;
                        return <PlatformIcon className={`w-5 h-5 ${meta.iconClass}`} />;
                      })()}
                    </div>
