    ...
    <div className="glass-panel rounded-xl overflow-hidden border border-border/60 flex flex-col min-h-[min(70vh,560px)] max-h-[min(88vh,760px)]">
      <div className="px-5 pt-5 pb-3 border-b border-border/60 shrink-0">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-xs text-muted-foreground">docker exec</span>
        </div>
        <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
          Shell session inside the first running service container (same target as compose / stack deploy). Requires the API host to
          reach Docker.
        </p>
      </div>
